...
export const routes: Routes = [
  ...
  { path: 'detalhes-pedido/:id', component: DetalhesPedidoComponent, canActivate: [adminGuard] },
  { path: 'editar-pedido/:id', component: EditarPedidoComponent, canActivate: [adminGuard] },
